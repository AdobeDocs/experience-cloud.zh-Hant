...
## 暫停、繼續或中止轉出計畫 {#pause-resume-abort}

控制進行中自動化或A/B測試轉出計畫的執行。

| 動作 | 端點 |
|---|---|
| **繼續** | `POST /m/api/v1/mgmt/phaserollout/resume` |
| **暫停** | `POST /m/api/v1/mgmt/phaserollout/pause` |
| **中止** | `POST /m/api/v1/mgmt/phaserollout/abort` |

### 要求內文 {#control-request-body}

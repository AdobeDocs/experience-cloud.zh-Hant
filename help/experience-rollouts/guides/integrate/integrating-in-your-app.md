---
title: 在您的應用程式中整合體驗轉出
description: 瞭解如何將Adobe體驗轉出整合至您的應用程式，無論其是Web服務、Web屬性、行動應用程式或案頭應用程式。
hide: true
...
# 在您的應用程式中整合體驗轉出 {#integrate}

本節提供依應用程式型別組織的所有Experience Rollout使用者端整合准則。
